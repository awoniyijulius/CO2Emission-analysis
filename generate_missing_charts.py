...
# Ensure pearson_r is a numeric scalar (in case it's unexpectedly tuple-like)
...
# If ttest_p is a tuple (older scipy), extract the p-value
...
# ============================================================================
print("Generating VISUALIZATION 5: Outliers & Clutch Moments...")
...
print("\n" + "="*70)
print("MISSING VISUALIZATIONS GENERATED SUCCESSFULLY!")
print("="*70)
print("\nAll 6 charts now complete:")
print("  [OK] 01_Main_Correlation_Analysis.png")
print("  [OK] 02_Regional_Disparities_Analysis.png")
print("  [OK] 03_High_vs_Low_Renewable_Analysis.png")
print("  [OK] 04_Top_10_Countries_Comparison.png")
print("  [OK] 05_Outliers_and_Clutch_Moments.png")
print("  [OK] 06_Summary_Statistics_Dashboard.png")
